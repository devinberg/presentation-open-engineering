...
% personal data
\newcommand{\myTitle}{\color{colorblue}\hugetext{OPEN ENGINEERING\\}}
\newcommand{\myName}{\largetext{\color{orange}{Devin R. Berg}}\\\setnote{www.devinberg.com}\\\setnote{@devinberg}\\\setnote{\#openengr}}
