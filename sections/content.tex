\begin{frame}{Presento}
 \begin{fullpageitemize}
  \item \begin{center}\largetext{The design is \underline{clean}}\footfullcite{Saussure1995}\end{center}
  \item \begin{center}\largetext{The rules are \underline{simple}}\footnote{footnote text}\end{center}
